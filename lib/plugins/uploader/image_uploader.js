        ...
        Async.reduce(image.versions, {}, (uploaded, versionContainer, reduceCallback) => {
            ...
            Async.auto({
                ...
                "upload": ["processSharp", (result, autoCallback) => {
                    ...
                    return forklift.upload(filePath, remote).then((url) => {
